...
// Copyright (c) 2013 The RomeCoin developers
...
uint256 hashGenesisBlock("0x00000a660b1cb2a4551cc361372a83e04442e3e5976553085844ea3c34330ba9");
static const unsigned int timeGenesisBlock = 1467597799;
...
const string strMessageMagic = "RomeCoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "RomeCoin create 06.22";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xf93a5b6201491681c75c523884ed9a9c5416fec6bad18c8a13f2ec77e06ed41c"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("RomeCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("RomeCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("RomeCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("RomeCoin-miner");
    ...
    try { loop {
        ...
        printf("Running RomeCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("RomeCoinMiner terminated\n");
        throw;
    }
}
