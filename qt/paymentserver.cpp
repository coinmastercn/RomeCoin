...
const QString BITCOIN_IPC_PREFIX("RomeCoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click RomeCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start RomeCoin: click-to-pay handler");
    else
...
{
    // clicking on RomeCoin: URLs creates FileOpen events on the Mac:
